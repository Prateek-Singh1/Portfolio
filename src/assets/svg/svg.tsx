...
export const Email = ({ color = '#35383F' }) => {
    return (
        <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2.45759 5.40673C2.32495 5.61793 2.41154 5.88824 2.62359 6.0195L11.4735 11.498C11.796 11.6977 12.2037 11.6977 12.5262 11.498L21.3764 6.01941C21.5884 5.88814 21.675 5.61782 21.5423 5.40662C21.0117 4.56167 20.0714 4 19 4H5C3.92853 4 2.98825 4.56171 2.45759 5.40673Z" fill={color} />
            <path d="M22 8.88312C22 8.49137 21.5699 8.25179 21.2368 8.45799L13.579 13.1986C12.6114 13.7975 11.3883 13.7975 10.4208 13.1986L2.76318 8.45812C2.43008 8.25192 2 8.4915 2 8.88326V17C2 18.6569 3.34315 20 5 20H19C20.6569 20 22 18.6569 22 17V8.88312Z" fill={color} />
        </svg>
...
export const RightTiltedArrow: React.FunctionComponent<RightTiltedArrowProps> = ({ color, className }) => {
    return (
